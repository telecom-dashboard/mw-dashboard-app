export const microwaveLinkBudgetColumns = [
  ...
  { key: "annual_multipath_availability_s1", label: "Annual multipath availability (%) S1" },
  { key: "annual_multipath_availability_s2", label: "Annual multipath availability (%) S2" },
  { key: "annual_rain_availability_s1", label: "Annual rain availability (%) S1" },
  { key: "annual_rain_availability_s2", label: "Annual rain availability (%) S2" },
